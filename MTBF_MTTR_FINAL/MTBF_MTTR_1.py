        ...
        with PLC() as comm:
            ...
            if A3[-1] == 0:
                ...
                if IDEAL_RUN_RATE == 0:
                    ...
                    if PERFORMANCE1 >= 1:
                        PERFORMANCE = 1
                        ACTUAL_PERFORMANCE = PERFORMANCE * 100
                    else:
            ...
            if production_time >= (SHIFT_LENGTH - TOTAL_BREAK_TIME) and not data_inserted1:
                ...
                values = (G[-1], DATETIME, A1[-1], A2[-1], failure_count, A3[-1], A4[-1], A5[-1], TOTAL_PIECES,
                          REJECTED_PIECES,
                          GOOD_PIECES, IDEAL_RUN_RATE, AVAILABILITY1, ACTUAL_PERFORMANCE, QUALITY1, OVERALL_OEE)
